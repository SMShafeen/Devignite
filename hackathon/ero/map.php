  ...
  <nav class="flex justify-between bg-gray-900">
    ...
    <div class="links pt-6 space-x-8 text-white">
      ...
      <!-- <a
            ...
            > -->
      <a href="map.php"
        class="contact text-[1.25rem] bg-gradient-to-r from-green-700 via-green-500 to-gray-200 text-transparent pr-[10rem]" style="
  ...
  <!-- <input type="text" name="" id="search-input" placeholder="Search a place..."> -->
    ...
    <div class="parent bg-sky-200 w-screen h-screen bg-opacity-0 flex overflow-x-hidden">
      ...
      <div class="searchbar">
        ...
        />
        <a href="route.php" class="btn bg-blue-950 text-white p-2 ml-[130px] rounded-lg hover:bg-white hover:text-blue-950 hover: border border-blue-950">Get Easiest Route</a>
      </div>
      ...
      <?php
        ...
        ?><a href="station.php?vendor=<?php echo $fetch_locations['id'] ?>">
        <div class="card bg-white hover:bg-slate-50 h-[150px] m-6 rounded-md shadow-md w-[88%] cursor-pointer hover:bg-rgba(0,0,0,0.3)">
